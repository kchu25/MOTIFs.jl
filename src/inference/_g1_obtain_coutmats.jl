...
function run_thru(data, cdl, hp, len, projs, this_bg)
    ...
    H_w_enriched_keys_mtm_p15   = get_H_w_enriched_keys_mtm_quantile(stored_code_component, data, this_bg, hp; quantile=0.15, get_how_many=1000)
    ...
    H_w_enriched_keys_mtm = merge(H_w_enriched_keys_mtm, H_w_enriched_keys_mtm_p15)
    H_w_enriched_keys_mtm = merge(H_w_enriched_keys_mtm, H_w_enriched_keys_mtm_p05)
